...
SELECT (id, lastname, firstname, nickname, mail, "password", trophies, honor_point, team, "role", created_at, updated_at) FROM public."user";
SELECT (id, label, "type", "date", game, "format", max_player_count, "user_id") FROM tournament;
